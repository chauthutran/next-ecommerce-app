    ...
    return (
        <header className="grid grid-cols-1 md:grid-cols-2 px-4 py-3 border-b-2 border-gray-200 gap-4">
            <div className="text-2xl flex space-x-3 cursor-pointer items-center" onClick={() => setMainPage(Constant.PAGE_HOME)}>
                {/* <div className="rounded-full bg-[#ADD8E6] text-[#00246B]"><SiWearos className="size-10" /></div> */}
                <div className="rounded-full bg-yellow-200 text-gray-600"><SiWearos className="size-10" /></div>
            ...
            <div className="flex mr-3 space-x-10 justify-center items-center">
                ...
                <button className="px-5 py-2 rounded-md bg-mustard-yellow">Login</button>
            </div>
